...
//		ForgeRegistries.ITEMS.register(itemGuhuaNiunai);
	...
	public static void registerRecipe(FMLInitializationEvent event){
		...
		//item and food
		addShapelessRecipe(ConstantUtil.MODID + ":HC_itemDanZiling1", ConstantUtil.MODID, new ItemStack(itemDanZiling, 4), Items.WHEAT, itemZiqi, Items.WHEAT);
		addRecipe(ConstantUtil.MODID + ":HC_itemDanShenshu1", ConstantUtil.MODID, new ItemStack(itemDanShenshu, 8), Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, itemZiqi, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS, Items.WHEAT_SEEDS);
		addRecipe(ConstantUtil.MODID + ":HC_itemDanShenshu2", ConstantUtil.MODID, new ItemStack(itemDanShenshu, 8), Items.BEETROOT_SEEDS, Items.BEETROOT_SEEDS, Items.BEETROOT_SEEDS, Items.BEETROOT_SEEDS, itemZiqi, Items.BEETROOT_SEEDS, Items.BEETROOT_SEEDS, Items.BEETROOT_SEEDS, Items.BEETROOT_SEEDS);
		addRecipe(ConstantUtil.MODID + ":HC_itemDanShenshu3", ConstantUtil.MODID, new ItemStack(itemDanShenshu, 8), Items.MELON_SEEDS, Items.MELON_SEEDS, Items.MELON_SEEDS, Items.MELON_SEEDS, itemZiqi, Items.MELON_SEEDS, Items.MELON_SEEDS, Items.MELON_SEEDS, Items.MELON_SEEDS);
		addRecipe(ConstantUtil.MODID + ":HC_itemDanShenshu4", ConstantUtil.MODID, new ItemStack(itemDanShenshu, 8), Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, itemZiqi, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS, Items.PUMPKIN_SEEDS);

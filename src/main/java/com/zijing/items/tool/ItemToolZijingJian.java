...
public class ItemToolZijingJian extends ItemSword{
	...
	public ItemToolZijingJian() {
		...
		setRegistryName(ConstantUtil.MODID + ":itemtoolzijingjian");
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn){
		tooltip.add(I18n.format(ConstantUtil.MODID + ".itemToolZijingJian.1", new Object[] {effectTick/20}));
		tooltip.add(I18n.format(ConstantUtil.MODID + ".itemToolZijingJian.2", new Object[] {effectTick/20}));
		tooltip.add(I18n.format(ConstantUtil.MODID + ".itemToolZijingJian.3", new Object[] {bloodRestore}));
		tooltip.add(I18n.format(ConstantUtil.MODID + ".itemToolZijingJian.4", new Object[] {xpDrop}));
	}
}

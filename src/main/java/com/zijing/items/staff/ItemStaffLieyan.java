...
public class ItemStaffLieyan extends Item implements MagicConsumer{
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn){
		tooltip.add(I18n.format(ZijingMod.MODID + ".itemStaffLieyan.skill1", new Object[] {MagicSkill1}));
		tooltip.add(I18n.format(ZijingMod.MODID + ".itemStaffLieyan.skill2", new Object[] {MagicSkill2}));
	}
}
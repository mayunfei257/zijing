...
public class Config {
	...
	private void load(){
		try {
			...
			this.UPGRADE_NEED_XP_K = configuration.get("PLAYER", "UPGRADE_NEED_XP_K", 30, new String(new byte[]{-2,-1,83,71,126,-89,-105,0,-119,-127,118,-124,126,-49,-102,-116,80,60,0,32,0,61,0,32,0,40,123,73,126,-89,0,32,0,42,0,32,123,73,126,-89,0,32,0,43,0,32,123,73,126,-89,0,41,0,32,0,42,0,32,0,75,0,32,0,47,0,32,0,50,-1,12,0,75,-98,-40,-117,-92,80,60,0,53,0,48}, "unicode")).getInt();

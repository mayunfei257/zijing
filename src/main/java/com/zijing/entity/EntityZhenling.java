...
import com.zijing.entity.ai.EntityAIRepelAttackZJ;
import com.zijing.entity.ai.EntityAIAttackRangedZJ;
import com.zijing.entity.ai.EntityAIAttackRangedZJ2;
...
public class EntityZhenling extends EntityFriendly implements IRangedAttackMob, net.minecraftforge.common.IShearable {
	...
	public EntityZhenling(World worldIn) {
		super(worldIn);
		this.setNoAI(false);
	...
	public EntityZhenling(World world, int baseLevel) {
	...
	protected void initEntityAI() {
		...
		this.tasks.addTask(0, new EntityAIRepelAttackZJ(this, 4, 4, SkillEntity.MagicSkill_BingDan));
		this.tasks.addTask(1, new EntityAIAttackRangedZJ2(this, 0, 4, 4, 16, SkillEntity.MagicSkill_BingDan));
		this.tasks.addTask(2, new EntityAIAttackMeleeZJ(this, 0, 4, false));
	...
	protected void setBaseShepherdCapability() {
		...
		this.setCustomNameTag(I18n.translateToLocalFormatted(ConstantUtil.MODID + ".entityZhenling.name", new Object[0]));
	}
	...
	protected void upEntityGrade(int upLevel) {
		...
		this.shepherdCapability.setSpeed(0);
		...
		this.shepherdCapability.setAttack(this.shepherdCapability.getAttack() * ConstantUtil.SPECIAL_K);
	...
	public boolean canAttackClass(Class<? extends EntityLivingBase> cls) {
		if ((cls == EntitySkeleton.class || cls == EntityStray.class) && this.shepherdCapability.getLevel() < 1) {
			return false;
		} else if (cls == EntityCreeper.class && this.shepherdCapability.getLevel() < 5) {
			return false;
	...
	public String getSpecialInstructions() {
		return I18n.translateToLocalFormatted(ConstantUtil.MODID + ".entityZhenling.special", new Object[] { ConstantUtil.SPECIAL_K });
	}
}